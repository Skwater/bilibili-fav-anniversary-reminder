...
- 🗓️ **历史日历**：在扩展 Popup 按年月浏览有历史投稿的日期，点击某天查看完整投稿列表，不改变首页的真实“今天”
- 📚 **收藏夹管理**：读取“我创建的 + 我收藏(追更)的”全部收藏夹，按来源分组、可折叠、可勾选
- 🧭 **首次向导**：第一次使用先选择要同步的收藏夹（区分自建/追更）再开始
- 🔄 **换号保护**：检测到 B 站账号切换后清理旧账号收藏缓存与同步进度，保留扩展设置并重新引导选择收藏夹
...
- **回顾**：Popup 切换到「历史日历」，用年月导航查看任意过往年份中的历史投稿
- **范围**：增量/全量按钮旁可选 全部 / 仅我创建的 / 仅追更的
- **高级设置**（设置页最底部折叠区）：412 冷却、每段页数、配额暂停时长、模拟首页日期、清空数据
